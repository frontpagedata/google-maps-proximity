...
FrontPage Data is looking forward to the comments and feedback from Rankings.io. Depending on the interests of Rankings.io, this analysis could be:  
...
* Extended to collect more samples for the top 10 cities, in order to refine the measurements (could be useful to better highlight the distance at which most of the law firms drop out of the top 20. Currently, at a 10-mile radius distance, we only collect 10 samples).   
