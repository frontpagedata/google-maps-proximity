...
We start by visualizing the average rank at each mile from the center location for each law firm in each cities. The average rank across all law firms is shown in black. It is computed with a rank of 21 for the firms out of the top 20 and for which the rank is not recorded anymore by Local Falcon.   
...
In order to better identify and compare the drop, we focus on the average drop only:  
...
* very variable btw firms
* some do not drop out of the top 20
* variable btw cities
* most drop in the first mile
* here is the table of the drop for the average btw all cities
* x% out of top 20 after 5 miles, and x after 10miles.
